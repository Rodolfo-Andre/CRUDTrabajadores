USE [master]
GO
/****** Object:  Database [Trabajadores]    Script Date: 10/11/2023 15:11:01 ******/
CREATE DATABASE [Trabajadores]
GO
ALTER DATABASE [Trabajadores] SET COMPATIBILITY_LEVEL = 150
GO
IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [Trabajadores].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
ALTER DATABASE [Trabajadores] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [Trabajadores] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [Trabajadores] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [Trabajadores] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [Trabajadores] SET ARITHABORT OFF 
GO
ALTER DATABASE [Trabajadores] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [Trabajadores] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [Trabajadores] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [Trabajadores] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [Trabajadores] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [Trabajadores] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [Trabajadores] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [Trabajadores] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [Trabajadores] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [Trabajadores] SET  DISABLE_BROKER 
GO
ALTER DATABASE [Trabajadores] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [Trabajadores] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [Trabajadores] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [Trabajadores] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [Trabajadores] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [Trabajadores] SET READ_COMMITTED_SNAPSHOT OFF 
GO
ALTER DATABASE [Trabajadores] SET HONOR_BROKER_PRIORITY OFF 
GO
ALTER DATABASE [Trabajadores] SET RECOVERY FULL 
GO
ALTER DATABASE [Trabajadores] SET  MULTI_USER 
GO
ALTER DATABASE [Trabajadores] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [Trabajadores] SET DB_CHAINING OFF 
GO
ALTER DATABASE [Trabajadores] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
ALTER DATABASE [Trabajadores] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO
ALTER DATABASE [Trabajadores] SET DELAYED_DURABILITY = DISABLED 
GO
ALTER DATABASE [Trabajadores] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO
EXEC sys.sp_db_vardecimal_storage_format N'Trabajadores', N'ON'
GO
ALTER DATABASE [Trabajadores] SET QUERY_STORE = OFF
GO
USE [Trabajadores]
GO
/****** Object:  Table [dbo].[Departamento]    Script Date: 10/11/2023 15:11:01 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Distrito]    Script Date: 10/11/2023 15:11:01 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Provincia]    Script Date: 10/11/2023 15:11:01 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Trabajador]    Script Date: 10/11/2023 15:11:01 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
ALTER TABLE [dbo].[Trabajador]  WITH CHECK ADD FOREIGN KEY([IdDepartamento])
REFERENCES [dbo].[Departamento] ([Id])
GO
ALTER TABLE [dbo].[Trabajador]  WITH CHECK ADD FOREIGN KEY([IdDistrito])
REFERENCES [dbo].[Distrito] ([Id])
GO
ALTER TABLE [dbo].[Trabajador]  WITH CHECK ADD FOREIGN KEY([IdProvincia])
REFERENCES [dbo].[Provincia] ([Id])
GO